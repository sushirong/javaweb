...
<body class="login-layout" background="assets/images/bg.jpg">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header blue lighter bigger">
                                        ...
                                        请输入你的信息 &nbsp; <span style="color: red" id="msg">${msg}</span>
                                    </h4>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header red lighter bigger">
                                        <i class="ace-icon fa fa-key"></i>
                                        Retrieve Password
                                        <span style="color: #7461AA" id="forgetMsg"></span>
                                    </h4>
                                    ...
                                    <form id="forgetForm">
                                        <fieldset>
                                            ...
                                            <div class="clearfix" style="margin-top:20px;">
                                                ...
                                                <button type="button" name="change" id="change"
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header green lighter bigger">
                                        ...
                                        新用户注册 &nbsp;<span id="regMsg" style="color: red"></span>
                                    </h4>
...
<script type="text/javascript">
    ...
    $("#loginBtn").on({
            "click": function () {
                ...
                $.post("${path}/user/login", serialize, function (data) {
                    console.log(data);
                    if (data.flag){
    ...
    $("#register").on({
            "click": function () {
                ...
                console.log(serialize);
                $.post("${path}/user/register", serialize, function (data) {
                    console.log(data);
                    if (data.flag){
    ...
    $("#send").on({
            "click": function () {
                ...
                console.log(obj);
                $.post("${path}/user/sendMail", obj, function (data) {
                    console.log(data);
                    if (data.flag){
    ...
    $("#change").on({
            "click": function () {
                ...
                if (code == uuid){
                    $.post("${path}/user/changePwd", obj, function (data) {
                        console.log(data);
                        if (data.flag){
