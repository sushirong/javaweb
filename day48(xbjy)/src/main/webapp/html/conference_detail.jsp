    ...
    <div class="main-content">
        <div style="position: absolute;margin: 20px 0 0 100px ;">
            <button type="button" class="btn btn-danger">
                <i class="glyphicon glyphicon-hand-up"></i> 取消会议
            </button>
            &nbsp;
            <button type="button" class="btn btn-success">
                <i class="glyphicon glyphicon-hand-up"></i> 参加会议
            </button>
        </div>
        <h1 style="text-align: center">关于《小标交友》项目部分模块功能升级</h1>
        <div class="articleDetail">
            ...
            <h5 style="text-align: right">日期：2019-05-10</h5>
        </div>
