...
public class UserService {
    ...
    public Integer updateUserInfo(User user, UserInfo userInfo) {
        Integer userResult = dao.updateUser(user);
        Integer userInfoResult = infodao.updateUserInfo(userInfo);
        return (userResult > 0 && userInfoResult > 0) ? 1 : 0;
    }
